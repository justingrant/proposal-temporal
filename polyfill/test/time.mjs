...
describe('Time', () => {
  describe('Structure', () => {
    ...
    describe('Time.prototype', () => {
      ...
      it('Time.prototype.equal is a Function', () => {
        equal(typeof Time.prototype.equal, 'function');
      });
  ...
  describe('Construction', () => {
    ...
    describe('time.equal() works', () => {
      const t1 = Time.from('08:44:15.321');
      const t2 = Time.from('14:23:30.123');
      it('equal', () => assert(t1.equal(t1)));
      it('unequal', () => assert(!t1.equal(t2)));
      it("doesn't cast argument", () => {
        throws(() => t1.equal('08:44:15.321'), TypeError);
        throws(() => t1.equal({ hour: 8, minute: 44, second: 15, millisecond: 321 }), TypeError);
      });
    });
  ...
  describe('time operations', () => {
    ...
    it(`Temporal.Time.from(${JSON.stringify(datetime)}) === ${fromed}`, () =>
      assert(Time.from(datetime).equal(fromed)));
