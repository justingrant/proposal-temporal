...
describe('Date', () => {
  describe('Structure', () => {
    ...
    describe('Date.prototype', () => {
      ...
      it('Date.prototype.equal is a Function', () => {
        equal(typeof Date.prototype.equal, 'function');
      });
  ...
  describe('date fields', () => {
    ...
    it(`Temporal.Date.from(${JSON.stringify(datetime)}) === (${fromed})`, () =>
      assert(Date.from(datetime).equal(fromed)));
  });
  ...
  describe('Date.from() works', () => {
    ...
    it('Date.from(number) is converted to string', () => Date.from(19761118).equal(Date.from('19761118')));
    it('basic format', () => {
  ...
  describe('Date.equal works', () => {
    const d1 = Date.from('1976-11-18');
    const d2 = Date.from('2019-06-30');
    it('equal', () => assert(d1.equal(d1)));
    it('unequal', () => assert(!d1.equal(d2)));
    it("doesn't cast argument", () => {
      throws(() => d2.equal({ year: 1976, month: 11, day: 18 }), TypeError);
      throws(() => d2.equal('1976-11-18'), TypeError);
    });
  });
