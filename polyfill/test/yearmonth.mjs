...
describe('YearMonth', () => {
  describe('Structure', () => {
    ...
    describe('YearMonth.prototype', () => {
      ...
      it('YearMonth.prototype.equal is a Function', () => {
        equal(typeof YearMonth.prototype.equal, 'function');
      });
  ...
  describe('Construction', () => {
    ...
    describe('.from()', () => {
      ...
      it('YearMonth.from(number) is converted to string', () =>
        assert(YearMonth.from(201906).equal(YearMonth.from('201906'))));
      it('basic format', () => {
  ...
  describe('YearMonth.equal() works', () => {
    const nov94 = YearMonth.from('1994-11');
    const jun13 = YearMonth.from('2013-06');
    it('equal', () => assert(nov94.equal(nov94)));
    it('unequal', () => assert(!nov94.equal(jun13)));
    it("doesn't cast argument", () => {
      throws(() => nov94.equal({ year: 1994, month: 11 }), TypeError);
      throws(() => nov94.equal('1994-11'), TypeError);
    });
  });
  describe('YearMonth.difference() works', () => {
    ...
    it(`${nov94}.plus(${diff}) == ${jun13}`, () => nov94.plus(diff).equal(jun13));
    it(`${jun13}.minus(${diff}) == ${nov94}`, () => jun13.minus(diff).equal(nov94));
    it("doesn't cast argument", () => {
