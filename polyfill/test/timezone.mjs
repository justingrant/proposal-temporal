...
describe('TimeZone', () => {
  ...
  describe('+01:00', () => {
    ...
    it(`${zone} has offset +01:00 in ns`, () => equal(zone.getOffsetFor(abs), 3600e9));
  ...
  describe('UTC', () => {
    ...
    const dtm = new Temporal.DateTime(1976, 11, 18, 15, 23, 30, 123, 456, 789);
    it(`${zone} has name ${zone}`, () => equal(zone.name, `${zone}`));
    it(`${zone} has offset +00:00 in ns`, () => equal(zone.getOffsetFor(abs), 0));
  ...
  describe('America/Los_Angeles', () => {
    ...
    const dtm = new Temporal.DateTime(1976, 11, 18, 15, 23, 30, 123, 456, 789);
    it(`${zone} has name ${zone}`, () => equal(zone.name, `${zone}`));
    it(`${zone} has offset -08:00 in ns`, () => equal(zone.getOffsetFor(abs), -8 * 3600e9));
