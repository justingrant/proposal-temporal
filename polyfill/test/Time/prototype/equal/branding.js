...
const equal = Temporal.Time.prototype.equal;
...
assert.throws(TypeError, () => equal.call(Temporal.Time), "Temporal.Time");
assert.throws(TypeError, () => equal.call(Temporal.Time.prototype), "Temporal.Time.prototype");
