...
describe('Intl', () => {
  ...
  describe('Non-ISO Calendars', () => {
    ...
    const fromWithCases = {
      ...
      japanese: {
        year2000: { year: 133, eraYear: 12, month: 1, day: 1, era: 'heisei' },
        year1: RangeError
      },
      persian: {
    ...
    for (let [id, tests] of Object.entries(fromWithCases)) {
      ...
      for (const [name, date] of Object.entries(dates)) {
        ...
        it(`from: ${id} ${name} ${getValues('from') === RangeError ? ' (throws)' : ''}`, () => {
          ...
          if (values.eraYear === undefined) values.eraYear = values.year;
        ...
        it(`with: ${id} ${name} ${getValues('with') === RangeError ? ' (throws)' : ''}`, () => {
          ...
          const afterWithYear = afterWithMonth.with({ year: 1000 });
          t = '(after setting day)';
          equal(`${t} year: ${afterWithYear.year}`, `${t} year: 1000`);
    ...
    */
    const addDaysWeeksCases = {
      iso8601: { year: 2000, month: 10, day: 7, monthCode: '10', eraYear: 2000, era: undefined },
      buddhist: { year: 2000, month: 10, day: 8, monthCode: '10', eraYear: 2000, era: 'be' },
      chinese: { year: 2000, month: 10, day: 16, monthCode: '10', eraYear: 2000, era: undefined },
      coptic: { year: 2000, month: 10, day: 11, monthCode: '10', eraYear: 2000, era: 'era1' },
      dangi: { year: 2000, month: 10, day: 16, monthCode: '10', eraYear: 2000, era: undefined },
      ...
      hebrew: { year: 2000, month: 10, day: 14, monthCode: '10', eraYear: 2000, era: undefined },
      ...
      japanese: { year: 2000, month: 10, day: 8, monthCode: '10', eraYear: 1849, era: 'reiwa' },
    ...
    const addMonthsCases = {
      iso8601: { year: 2001, month: 6, day: 1, monthCode: '6', eraYear: 2001, era: undefined },
      buddhist: { year: 2001, month: 6, day: 1, monthCode: '6', eraYear: 2001, era: 'be' },
      chinese: { year: 2001, month: 6, day: 1, monthCode: '5', eraYear: 2001, era: undefined },
      coptic: { year: 2001, month: 5, day: 1, monthCode: '5', eraYear: 2001, era: 'era1' },
      dangi: { year: 2001, month: 6, day: 1, monthCode: '5', eraYear: 2001, era: undefined },
      ...
      hebrew: { year: 2001, month: 6, day: 1, monthCode: '5L', eraYear: 2001, era: undefined },
      ...
      japanese: { year: 2001, month: 6, day: 1, monthCode: '6', eraYear: 1850, era: 'reiwa' },
