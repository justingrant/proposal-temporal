...
describe('MonthDay', () => {
  describe('Structure', () => {
    ...
    describe('MonthDay.prototype', () => {
      it('MonthDay.prototype.equal is a Function', () => {
        equal(typeof MonthDay.prototype.equal, 'function');
      });
  ...
  describe('Construction', () => {
    ...
    describe('.from()', () => {
      ...
      it('MonthDay.from(number) is converted to string', () =>
        assert(MonthDay.from(1201).equal(MonthDay.from('12-01'))));
      it('basic format', () => {
  ...
  describe('MonthDay.equal()', () => {
    const md1 = MonthDay.from('01-22');
    const md2 = MonthDay.from('12-15');
    it('equal', () => assert(md1.equal(md1)));
    it('unequal', () => assert(!md1.equal(md2)));
    it("doesn't cast argument", () => {
      throws(() => md1.equal('01-22'), TypeError);
      throws(() => md1.equal({ month: 1, day: 22 }), TypeError);
    });
  });
